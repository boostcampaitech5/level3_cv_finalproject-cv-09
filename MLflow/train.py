...
def get_arg():
    ...
    parser.add_argument("--val_batch",type=int, default=8, help='set val and test batch size. default=8')
    parser.add_argument("--lr",type=float, default=5e-4, help='set learning rate. default=5e-4')
    parser.add_argument("--epochs",type=int,default=50, help='set training epoch. default=50')
    parser.add_argument("--accelerator", choices=['cpu','gpu','auto'],default='gpu',help='set training device. default=gpu')
    parser.add_argument("--precision", choices=['32','16'],default='16',help='set training mode. if 16, use mixed-precision. default=16')
    parser.add_argument("--seed", type=int , default=42,help='set random seed. default=42')
    parser.add_argument("--regist_name", type=str, default="register_model",help='set regist name. default=register_model')
    parser.add_argument("--bn_type", type=str, default= 'torchbn',help='set batchnorm type. default=torchbn')
    parser.add_argument("--num_classes", type=int, default= 19, help='set num-classes. default=19')
    parser.add_argument("--backbone", type=str, default='hrnet48', help='set model backbone. default=hrnet48')
