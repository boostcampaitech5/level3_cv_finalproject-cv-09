...
class HighResolutionNet(nn.Module):
    def __init__(self, cfg, bn_type, bn_momentum, **kwargs):
        ...
        self.transition1 = self._make_transition_layer(
            [256], num_channels, bn_type=bn_type, bn_momentum=bn_momentum
        )
...
class HRNetBackbone(object):
    ...
    def __call__(self):
        ...
        from hrnet.models.model_config import MODEL_CONFIGS

        # hrnet48
        if arch == "hrnet48":
            arch_net = HighResolutionNet(
                MODEL_CONFIGS["hrnet48"], bn_type=self.configer.bn_type, bn_momentum=0.1
            )
